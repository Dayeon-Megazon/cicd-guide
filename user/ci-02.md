...
`DEV-Admin_IMAGE_NAME`과 `DEV-Admin_IMAGE_NAME`에서 앞에 붙은 `DEV-`를 지워  
Admin_IMAGE_NAME과 Admin_IMAGE_NAME 으로 수정합니다.  
...
- Admin-docker-build의 script 첫 번째에 `cd atomy-club-web/atomy-club-web-admin` 추가    
- Front-docker-build script 첫 번째에 `cd atomy-club-web/atomy-club-web-front` 추가    
...
Admin-docker-build의 script 첫 번째 | - cd atomy-club-web/atomy-club-web-admin (추가)
Front-docker-build script 첫 번째 |  - cd atomy-club-web/atomy-club-web-front (추가)
