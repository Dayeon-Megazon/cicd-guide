...
깃랩에 새로운 사용자를 추가하고 권한을 주기 위해서는 `Maintainer 이상의 권한을 가진 관리자 계정`이 필요합니다.
...
> 주의2 : 문자, 숫자, '_', '-'및 '.'만 포함 할 수 있습니다. '-'로 시작하거나 '.', '.git'또는 '.atom'으로 끝날 수 없습니다.       
> 주의2 : Username을 `한글`로 작성하면 오류가 발생하니 `영어`로 작성해주시기 바랍니다.
